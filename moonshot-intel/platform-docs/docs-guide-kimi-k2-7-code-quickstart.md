...
* `kimi-k2.7-code`, `kimi-k2.7-code-highspeed`, `kimi-k2.6`, `kimi-k2.5` models all provide a 256K context window.
...
Parameters are listed in [chat](/docs/api/chat). However, behaviour of some parameters may be different in k2.7-code/k2.6/k2.5 models.
